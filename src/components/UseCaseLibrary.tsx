...
import type { UseCaseLibraryEntry, UseCaseCategory } from '../types';
    ...
    <div className="max-w-[1200px] mx-auto px-6 py-8">
      <header className="flex items-end justify-between mb-8">
        <div>
          ...
          <h1 className="text-[24px] font-semibold tracking-tight">Use Case Library</h1>
          <p className="text-[13px] text-[var(--color-text-muted)] mt-1 max-w-2xl">
            Reusable use case templates the team can drop into any POC. Edits to library entries do{' '}
      ...
      {error && (
        <div className="bg-[#2a1414] border border-[#4a2222] text-[var(--color-danger)] text-[12px] px-4 py-2 rounded mb-4">
          {error}
        </div>
      )}
